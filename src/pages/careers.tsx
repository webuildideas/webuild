  ...
  return <>
    ...
    <div className="Careers overflow-x-hidden">
      ...
      <div className="Careers-team">
        ...
        <GatsbyImage
          image={teamLg.childImageSharp.gatsbyImageData}
          className="Careers-team__image-lg"
          durationFadeIn={150}
          fadeIn />
        <GatsbyImage
          image={teamSm.childImageSharp.gatsbyImageData}
...
export const CAREERS_PAGE_QUERY = graphql`query CareersPageQuery {
  ...
  teamTestimonials: allContentfulTestimonial(
    filter: {name: {in: ["Mackenzie Almquist-Murray", "Abby Milan", "Norton King"]}}
  ) {
    nodes {
      name
      role
