      ...
      <div className="Fintech-latest-work">
        ...
        <div className="Fintech-mobile-gallery">
          <div
            ...
            style={{
              backgroundImage: `url(${mobileGallery.childImageSharp.gatsbyImageData.src})`
            }}
          />
        </div>
        <div ref={ref} className="Fintech-latest-work-gallery">
          ...
          >
            <GatsbyImage
              image={row11.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
          ...
          >
            <GatsbyImage
              image={row12.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row13.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row21.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row22.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row23.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row24.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row25.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row31.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
          ...
          >
            <GatsbyImage
              image={row32.childImageSharp.gatsbyImageData}
              durationFadeIn={150}
              fadeIn
              imgStyle={{ objectFit: 'cover' }} />
          </motion.div>
...
export const FINTECH_PAGE_QUERY = graphql`query FintechPageQuery {
  ...
  allContentfulTestimonial(
    filter: {name: {in: ["Alex Goode", "Brad Lindenberg", "Brian Johnson", "Ian Yamey", "Andrew Josuweit"]}}
  ) {
    nodes {
      company
      name
