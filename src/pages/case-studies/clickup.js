...
const ClickUp = ({
  ...
  const designImgSources = [
    designsMobile.childImageSharp.gatsbyImageData,
    {
      ...designsDesktop.childImageSharp.gatsbyImageData,
            ...
            <div className="md:flex items-center gap-x-22 md:max-w-xs m-auto">
              <div className="people flex-1 grid">
                <div className="person-info text-blueRibbon font-light flex items-center justify-between">
                  <GatsbyImage
                    image={sepHeadshot.childImageSharp.gatsbyImageData}
          ...
          <CaseStudyContainer>
            ...
            <div className="mt-10 md:flex md:flex-wrap md:justify-center md:gap-x-8 xl:flex-nowrap xl:mt-0">
              <div className="mt-4 md:w-5/12 xl:w-full xl:mt-8">
                <GatsbyImage image={emailCardOne.childImageSharp.gatsbyImageData} />
              </div>
              <div className="mt-4 md:w-5/12 xl:w-full xl:mt-40">
                <GatsbyImage image={emailCardTwo.childImageSharp.gatsbyImageData} />
              </div>
              <div className="mt-4 md:w-5/12 xl:w-full xl:mt-16">
                <GatsbyImage image={emailCardThree.childImageSharp.gatsbyImageData} />
              </div>
            </div>
            <div className="rounded-10 overflow-hidden mt-10 lg:mt-15">
              <GatsbyImage image={emailDiagram.childImageSharp.gatsbyImageData} />
            </div>
        ...
        <section className="other-shots max-w-screen-s1536 mx-auto">
          <div className="bg-gray-300 px-6 py-10 md:mt-20 md:px-6 lg:mx-12 lg:px-12 lg:pb-20 xl:px-8 xl:pt-10 s1440:mx-30 s1536:mx-52 s1536:px-12">
            <div className="bg-gray-400 rounded-8 p-6 grid gap-6 md:grid-cols-3 xl:gap-12 xl:p-10">
              ...
              >
                <GatsbyImage image={otherShotOne.childImageSharp.gatsbyImageData} />
              </div>
              <div
                className="rounded-10 overflow-hidden border border-solid border-gray-500"
                style={{
              ...
              >
                <GatsbyImage image={otherShotThree.childImageSharp.gatsbyImageData} />
              </div>
              <div
                className="rounded-10 overflow-hidden border border-solid border-gray-500"
                style={{
              ...
              >
                <GatsbyImage image={otherShotTwo.childImageSharp.gatsbyImageData} />
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:px-18 s1536:px-6">
              ...
              >
                <GatsbyImage image={otherShotFour.childImageSharp.gatsbyImageData} className="h-full" />
              </div>
              ...
              >
                <GatsbyImage image={otherShotFive.childImageSharp.gatsbyImageData} className="w-full" />
              </div>
            </div>
...
export const CLICKUP_QUERY = graphql`query clickupQuery {
  ...
  HeroImg: file(relativePath: {eq: "case-studies/clickup/clickup-hero.png"}) {
    childImageSharp {
  ...
  emailCardOne: file(relativePath: {eq: "case-studies/clickup/card-1.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  emailCardTwo: file(relativePath: {eq: "case-studies/clickup/card-2.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  emailCardThree: file(relativePath: {eq: "case-studies/clickup/card-3.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  emailDiagram: file(relativePath: {eq: "case-studies/clickup/diagram.jpg"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenOne: file(relativePath: {eq: "case-studies/clickup/screen-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenTwo: file(relativePath: {eq: "case-studies/clickup/screen-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenThree: file(relativePath: {eq: "case-studies/clickup/screen-three.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenFour: file(relativePath: {eq: "case-studies/clickup/screen-four.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenFive: file(relativePath: {eq: "case-studies/clickup/screen-five.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
