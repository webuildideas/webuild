...
const Quadpay = ({
  ...
  const photoGridSources = [
    photoGridMobile.childImageSharp.gatsbyImageData,
    {
      ...photoGridDesktop.childImageSharp.gatsbyImageData,
      media: `(min-width: 768px)`
    }
  ]

  const identityGridSources = [
    identityGridMobile.childImageSharp.gatsbyImageData,
    {
      ...identityGridDesktop.childImageSharp.gatsbyImageData,
      media: `(min-width: 768px)`
    }
  ]
      ...
      <main>
        ...
        <section className="mx-auto px-4 md:px-6 lg:px-12 mt-20 s1440:mt-35">
          <div className="w-full">
            <GatsbyImage image={photoGridSources} className="w-full" />
          </div>
          ...
          <div className="max-w-screen-1536 exp-services-wrapper mx-auto xl:pt-20 xl:pb-10 xl:grid s1440:px-30 s1536:px-52">
            <div className="exp-services-container md:grid md:grid-cols-2 md:items-start">
              ...
              <div className="exp-services-img-one mt-10 md:order-1 md:pr-30 md:pl-0 md:mt-0 xl:pr-20">
                <GatsbyImage image={brandColorsImg.childImageSharp.gatsbyImageData} />
            ...
            <div className="exp-services-container md:grid md:grid-cols-2 md:items-start single">
              <div className="relative exp-services-img-two mt-20 md:order-4 md:mt-0 md:pr-16 lg:w-3/5 lg:ml-auto xl:order-1 xl:pr-0">
                <GatsbyImage image={originalIconsImg.childImageSharp.gatsbyImageData} />
              ...
              <div className="exp-services-img-three mt-20 md:order-3 md:pr-30 md:pl-10 xl:pr-0 xl:pl-0 xl:w-10/12 xl:ml-auto">
                ...
                <GatsbyImage image={logoGridImg.childImageSharp.gatsbyImageData} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto px-4 md:px-6 lg:px-12">
          <div className="w-full">
            <GatsbyImage image={identityGridSources} className="w-full" />
          </div>
          <div className="flex mt-6">
            <svg
              fill="none"
        ...
        <section className="mt-20 lg:mt-35 mb-20">
          ...
          <CaseStudyContainer className="flex flex-wrap justify-center lg:flex-nowrap mt-20 lg:mt-35 mb-10">
            <div className="w-1/2 pr-4 mt-37 md:w-1/3 md:pl-6 md:pr-6 md:mt-48">
              <GatsbyImage image={screenOne.childImageSharp.gatsbyImageData} />
            </div>
            <div className="w-1/2 pl-4 md:w-1/3 md:pl-6 md:pr-6 md:mt-24">
              <GatsbyImage image={screenTwo.childImageSharp.gatsbyImageData} />
            ...
            <div className="w-1/2 pr-4 mt-16 md:w-1/3 md:pl-6 md:pr-6 md:mt-0">
              <GatsbyImage image={screenThree.childImageSharp.gatsbyImageData} />
              <div className="flex mt-4 items-start">
                <ArrowRight className="transform -rotate-90 w-12 h-auto -ml-2" />
                <p className="font-courier text-xs flex-1 leading-normal">
            ...
            <div className="w-1/2 pl-4 mt-34 md:w-1/3 md:pr-6 md:pl-0 md:mt-20">
              <GatsbyImage image={screenFour.childImageSharp.gatsbyImageData} />
            </div>
            <div className="w-1/2 mt-16 md:w-1/3 md:pl-6 md:mt-40">
              <GatsbyImage image={screenFive.childImageSharp.gatsbyImageData} />
            </div>
          </CaseStudyContainer>
          <CaseStudyContainer>
            <CaseStudyTextContainer className="mt-20">
          ...
          <div className="whitespace-nowrap overflow-auto lg:whitespace-normal p-6 md:flex lg:px-12">
            <div className="store-front-scrollz pb-12 ">
              <div className="grid grid-cols-3 gap-x-4 md:flex md:gap-x-0">
                <GatsbyImage
                  image={dealsImg.childImageSharp.gatsbyImageData}
                  className="md:flex-1 md:mr-4" />
                <GatsbyImage
                  image={walkthroughImg.childImageSharp.gatsbyImageData}
                  className="md:flex-1 md:mr-4" />
                <GatsbyImage
                  image={paymentOneImg.childImageSharp.gatsbyImageData}
                  className="md:flex-1 md:mr-4" />
                <div className="hidden md:block relative md:flex-1 md:ml-6 lg:ml-20 xl:ml-26">
                  <GatsbyImage image={paymentTwoImg.childImageSharp.gatsbyImageData} />
                ...
                >
                  {videos.map((video, index) => {
                    ...
                    return (
                      ...
                      >
                        <GatsbyImage
                          image={video.coverImg.childImageSharp.gatsbyImageData}
                  ...
                  >
                    ...
                    <div className="old-image-container relative my-6 md:absolute md:px-0 md:top-0 md:left-0 md:w-full md:h-full md:my-0 pointer-events-none">
                      <div className="relative z-10 md:hidden">
                        <GatsbyImage image={beforeImg.childImageSharp.gatsbyImageData} />
                      </div>
                      <div
                        className={`absolute p-px top-0 left-0 w-full h-auto md:relative transition ease-in-out duration-300 ${oldImgClasses}`}
                      >
                        <GatsbyImage image={afterImg.childImageSharp.gatsbyImageData} className="" />
                      </div>
                    </div>
                    {isTablet ? (
                      <button
...
export const QUADPAY_QUERY = graphql`query quadpayQuery {
  ...
  socialShare: file(relativePath: {eq: "case-studies/quadpay/social-share.jpg"}) {
    publicURL
  }
  HeroImg: file(relativePath: {eq: "case-studies/quadpay/quadpay-hero-img.jpg"}) {
    childImageSharp {
  ...
  photoGridMobile: file(
    ...
    childImageSharp {
      gatsbyImageData(width: 900, placeholder: NONE, layout: CONSTRAINED)
    }
  }
  ...
  screenOne: file(relativePath: {eq: "case-studies/quadpay/screen-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenTwo: file(relativePath: {eq: "case-studies/quadpay/screen-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenThree: file(relativePath: {eq: "case-studies/quadpay/screen-three.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenFour: file(relativePath: {eq: "case-studies/quadpay/screen-four.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  screenFive: file(relativePath: {eq: "case-studies/quadpay/screen-five.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  walkthroughImg: file(relativePath: {eq: "case-studies/quadpay/walkthrough.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  paymentOneImg: file(relativePath: {eq: "case-studies/quadpay/payment-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  paymentTwoImg: file(relativePath: {eq: "case-studies/quadpay/payment-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  logoGridImg: file(relativePath: {eq: "case-studies/quadpay/logo-grid.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  beforeImg: file(relativePath: {eq: "case-studies/quadpay/before-img.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  edgeCover: file(relativePath: {eq: "case-studies/quadpay/edge-cover.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  chromeCover: file(relativePath: {eq: "case-studies/quadpay/chrome-cover.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
