...
const Yotta = ({
  ...
  const designImgSources = [
    yottaDesignsMobile.childImageSharp.gatsbyImageData,
    {
      ...yottaDesignsDesktop.childImageSharp.gatsbyImageData,
  ...
  const beforeAndAfter = [
    {
      ...
      beforeImage: yottaOldOne.childImageSharp.gatsbyImageData,
      afterImage: yottaNewOne.childImageSharp.gatsbyImageData
    },
    {
      ...
      beforeImage: yottaOldTwo.childImageSharp.gatsbyImageData,
      afterImage: yottaNewTwo.childImageSharp.gatsbyImageData
    },
    {
      ...
      beforeImage: yottaOldThree.childImageSharp.gatsbyImageData,
      afterImage: yottaNewThree.childImageSharp.gatsbyImageData
    }
  ]
      ...
      <main>
        <section className="yotta-hero bg-newBlack w-screen">
          <div className="yotta-container pt-44 lg:flex lg:items-center gap-10 lg:pb-20">
            ...
            <div className="img mt-11 w-full transform translate-y-9 md:translate-y-18 md:mt-2 lg:transform-none">
              <GatsbyImage image={yottaHeroImg.childImageSharp.gatsbyImageData} />
            </div>
          </div>
        </section>
        {/* TESTIMONIAL */}
            ...
            <div className="md:flex items-center gap-x-22 md:max-w-xs m-auto">
              <div className="people flex-1 grid">
                <div className="person-info text-blueRibbon font-light flex items-center justify-between">
                  <GatsbyImage
                    image={adamHeadshot.childImageSharp.gatsbyImageData}
        ...
        <section className="photo-grid bg-electricViolet py-10 px-6 mt-21 md:mx-6 md:px-10 lg:py-20 lg:px-20 max-w-screen-1536">
          <div className="photo-grid__container">
            <GatsbyImage image={designImgSources} />
          </div>
        </section>
        {/* STATS */}
          ...
          <div className="yotta-brand-product-grid max-w-screen-1536 mx-auto xl:pt-20 xl:pb-10">
            ...
            <div className="yotta-brand-img-grid mt-20 md:mt-24 xl:mt-0">
              ...
              <div className="brand-img-three px-6 mt-25 md:px-0 md:mt-0 xl:w-3/5 xl:mx-auto xl:self-end">
                <GatsbyImage image={brandImgThree.childImageSharp.gatsbyImageData} />
                <div className="caption-one flex items-center justify-center py-4 px-6 border border-solid border-gray-700 rounded-8 mt-5 md:mt-2 md:flex-col md:items-start">
                  <ArrowRight className="transform -rotate-90 w-11 h-auto mr-4 md:mb-2 md:-translate-x-3" />
                  <p className="font-courier text-gray-600 text-sm flex-1 leading-normal">
              ...
              <div className="brand-img-four px-6 mt-25 md:px-0 md:ml-auto md:flex md:flex-col md:mt-0 xl:w-3/5 xl:ml-auto">
                <GatsbyImage
                  image={brandImgFour.childImageSharp.gatsbyImageData}
              ...
              <div className="rounded-2 overflow-hidden mt-6 md:mt-2 lg:rounded-4">
                <ReactCompareSlider
                  ...
                  itemOne={
                    <ReactCompareSliderImage
                      alt="Image one"
                      src={compareImgOld.childImageSharp.gatsbyImageData.src}
                    />
                  }
                  itemTwo={
                    <ReactCompareSliderImage
                      alt="Image two"
                      src={compareImgNew.childImageSharp.gatsbyImageData.src}
                    />
                  }
        ...
        <section className="yotta-more-app-screens">
          <div className="yotta-container yotta-screens grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-6 md:gap-x-12 lg:pb-20">
            <div className="mt-23 md:mt-48">
              <GatsbyImage image={appScreenOne.childImageSharp.gatsbyImageData} className="w-full" />
            </div>
            <div className="mt-4 md:mt-24">
              <GatsbyImage image={appScreenTwo.childImageSharp.gatsbyImageData} className="w-full" />
            ...
            <div className="order-5 md:order-3 mt-16 md:mt-0">
              <GatsbyImage image={appScreenThree.childImageSharp.gatsbyImageData} className="w-full" />
            ...
            <div className="order-6 md:order-4 mt-42 md:mt-20">
              <GatsbyImage image={appScreenFour.childImageSharp.gatsbyImageData} className="w-full" />
            </div>
            <div
            ...
            <div className="order-4 mt-16 md:order-6 md:mt-20">
              <GatsbyImage image={appScreenSix.childImageSharp.gatsbyImageData} className="w-full" />
            </div>
          </div>
        </section>
        {/* RESULTS */}
...
export const YOTTA_QUERY = graphql`query yottaQuery {
  ...
  yottaHeroImg: file(relativePath: {eq: "case-studies/yotta/yotta-hero.jpg"}) {
    childImageSharp {
  ...
  brandImgOne: file(relativePath: {eq: "case-studies/yotta/yotta-brand-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  brandImgTwo: file(relativePath: {eq: "case-studies/yotta/yotta-brand-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  appScreenOne: file(relativePath: {eq: "case-studies/yotta/app-screen-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  appScreenTwo: file(relativePath: {eq: "case-studies/yotta/app-screen-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  appScreenSix: file(relativePath: {eq: "case-studies/yotta/app-screen-six.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  adamHeadshot: file(relativePath: {eq: "case-studies/yotta/yotta-headshot.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  yottaNewOne: file(relativePath: {eq: "case-studies/yotta/yotta-new-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  yottaNewTwo: file(relativePath: {eq: "case-studies/yotta/yotta-new-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  ...
  yottaOldOne: file(relativePath: {eq: "case-studies/yotta/yotta-old-one.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
  yottaOldTwo: file(relativePath: {eq: "case-studies/yotta/yotta-old-two.png"}) {
    childImageSharp {
      gatsbyImageData(placeholder: NONE, layout: FULL_WIDTH)
    }
  }
